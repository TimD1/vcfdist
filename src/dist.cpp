...
/**
 * Check whether a hash set contains a value.
 *
 * @param hash_set A hash set, typically storing the indices already traversed during alignment.
 * @param value A value to search for, typically a 4-tuple storing the current index.
 * @returns Whether the value is in the hash_set.
 */
template <typename T>
...
/**
 * Check whether an unordered map contains an key.
 *
 * @param map An unordered map, typically storing indices and their predecessors.
 * @param key A key to search for, typically a 4-tuple storing the current key.
...
/**
 * Calculate the NG50 from a list of phase block sizes and genome size.
 *
 * @param phase_blocks List of phase block sizes.
 * @param total_bases Sum total of all bases in the genome.
 * @returns The minimum value for which the sum of phase blocks greater than this size account for
 *    >50% of total genome size, or 0 if less than 50% of the genome is phased.
 */
...
/**
 * Generate the sequence obtained by applying variants within a range to the reference sequence.
 *
 * @param ref A pointer to an object containing the reference sequence.
 * @param vars A pointer to the variants on this contig.
 * @param ctg The name of the current contig.
 * @param beg_idx The 0-based inclusive index of the first variant to include.
 * @param end_idx The 0-based exclusive index of the last variant to include.
 * @param beg_pos The 0-based inclusive index of the first reference base to include.
 * @param end_pos The 0-based exclusive index of the last reference base to include.
 * @param min_qual Skip variants with quality scores below this threshold.
 * @returns The sequence generated by applying the selected variants to the reference sequence.
 */
...
/**
 * Calculate initial forward-pass alignment for a truth string and query graph.
 *
