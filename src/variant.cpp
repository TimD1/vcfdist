 ...
 * the record's own FORMAT keys are appended to the fixed list. A variant with no retained source
 * record falls back to the placeholders '.', '.', PASS, and '.'.
 ...
 *         calls, missing PS tags, oversized variants, overlapping variants, complex variants
 *         split into INS + DEL, and ALT-indexed fields left out of the summary VCF
 */
