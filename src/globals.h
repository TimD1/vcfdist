...
extern std::vector<std::string> sideline_strs;  ///< FILTER IDs of SIDELINE_* retention reasons
extern std::vector<std::string> sideline_descs; ///< Descriptions of each sideline_strs FILTER ID
